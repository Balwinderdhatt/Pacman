    ...
    def __init__(self, app, pos):
        ...
        for i in range(1, 9, 1):
            ...
            self.anim_pacmanR[i] = pygame.image.load(
                os.path.join(SCRIPT_PATH, "assets/", "pacman-r " + str(i) + ".gif")).convert()
            self.anim_pacmanU[i] = pygame.image.load(
                os.path.join(SCRIPT_PATH, "assets/", "pacman-u " + str(i) + ".gif")).convert()
            self.anim_pacmanS[i] = pygame.image.load(os.path.join(SCRIPT_PATH, "assets/", "pacman.gif")).convert()
